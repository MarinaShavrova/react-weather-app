  ...
  const search = () => {
    if (city.length != 0) {
      ...
      axios
        ...
        .catch((err) => {
          alert(
            "City name entered incorrectly! Please enter a name in English!"
          );
        });
    }
  };
          ...
          <div className="row">
            <div className="col ms-5">
              ...
              <h3 className="main-block-h3">
                {nameDay[now.getDay()]}, {now.getDate()}{" "}
                {monthArr[now.getMonth()]} {now.getFullYear()}
              </h3>
            </div>
      ...
      <>
        <div className="container all-background ps-5 pe-5 mt-5">
          <div className="beforeInputCity">
            ...
            <h1 className="main-block-h3">
              Enter a city to search. Click on icon
            </h1>
            <button
              className="button-main-screen"
              onClick={() =>
                document.querySelector("#navbarToggleExternalContent")
                  .className === "collapse"
            ...
            >
              <span>&#10139;</span>
              <img src={iconMainScreen} alt="icon" />
            </button>
          </div>
        </div>
      </>

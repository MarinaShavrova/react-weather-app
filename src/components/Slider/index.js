                ...
                {index === current && (
                    ...
                    <div className="container container-sm mobile ps-5 pe-5 mt-4">                
                        ...
                        <div className="slider-flex">
                            ...
                            <div className="lineChart dis"> <LineChart data_test={slide.value}/></div>
                            </div>
                    </>
                )}              
            </div>        
